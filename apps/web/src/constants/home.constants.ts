...
export const ARCHITECTURE_CONTENT = {
  tag: "Architecture",
  title: "High-Throughput Cryptographic Pipeline",
  description:
    "Designed for mission-critical B2B SaaS workloads with zero-blocking async queues and Postgres ledger storage.",
  steps: [
...
export const LIVE_FEED_CONTENT = {
  ...
  headers: ["SEQ #", "ACTION EVENT", "IDEMPOTENCY KEY", "COMPUTED HASH", "STATUS"]
};
...
export const METRICS_CONTENT = {
  ...
  metrics: [
    { label: "P99 INGESTION LATENCY", value: "4.2ms", detail: "Asynchronous queue submission" },
    { label: "CHAIN VERIFICATION ACCURACY", value: "100%", detail: "Zero false positive tamper detection" },
    { label: "THROUGHPUT CAPACITY", value: "50,000+", detail: "Events per second per worker node" }
  ]
};
...
export const PRICING_CONTENT = {
  tag: "Open Source & Hosted",
  title: "Simple, Transparent Pricing",
  description: "Self-host the open-source engine or scale with managed cloud infrastructure.",
  headers: ["Feature", "Self-Hosted", "Cloud", "Enterprise"],
  rows: [
...
export const ARCHITECTURE_STEPS = ARCHITECTURE_CONTENT.steps;
export const REFERENCE_TABS = REFERENCE_CONTENT.tabs;
export const PRICING_ROWS = PRICING_CONTENT.rows;
