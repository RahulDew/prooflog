...
export interface LifecycleGridProps {
  isDark: boolean;
}
        ...
        {LIFECYCLE_CONTENT.cards.map((card, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className={`mt-4 pt-4 border-t flex items-center gap-1 text-xs font-mono text-orange-500 cursor-pointer ${isDark ? "border-zinc-800/50" : "border-zinc-200"}`}>
                <span>VIEW SPEC</span>
