  ...
  return (
    <section className="py-20">
      <div className="text-left mb-12">
        <span className="section-tag-orange">{LIFECYCLE_CONTENT.tag}</span>
            ...
            >
              <div className="flex-between mb-4">
                ...
                <Icon
                  size={20}
                  strokeWidth={2}
                  className="text-zinc-400 group-hover:text-zinc-800 dark:text-zinc-500 dark:group-hover:text-zinc-200 transition-colors"
                />
              </div>
