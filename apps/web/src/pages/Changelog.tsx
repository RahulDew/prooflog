...
import { RELEASES, CHANGELOG_CONTENT, type ReleaseInfo } from "../constants/changelog.constants";
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 text-left space-y-12">
        ...
        <div className="space-y-8 pt-2">
          ...
          {filteredReleases.length === 0 && (
            <div className={`p-8 text-center rounded-[4px] border font-mono text-xs ${isDark ? "bg-[#0a0a0c] border-zinc-800 text-zinc-400" : "bg-zinc-50 border-zinc-300 text-zinc-600"}`}>
        ...
        >
          <h3 className="text-xl font-extrabold font-mono mb-2">{CHANGELOG_CONTENT.ctaTitle}</h3>
