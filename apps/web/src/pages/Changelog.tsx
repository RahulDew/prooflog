...
export default function Changelog() {
  ...
  return (
    <div className="pt-24 min-h-screen relative pb-24">
      <div className="fixed inset-0 pointer-events-none z-0 bg-[radial-gradient(ellipse_at_top_right,rgba(59,130,246,0.05),transparent_50%)]" />
            ...
            <div key={i} className="relative pl-8 md:pl-0">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-12">
                <div className="md:w-32 shrink-0 pt-1 relative">
                  {/* Timeline Dot */}
                  <div className="absolute left-[-29px] md:left-[151px] top-2.5 w-3 h-3 rounded-full bg-blue-500 shadow-[0_0_10px_theme(colors.blue.500)]" />
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider bg-blue-500/10 text-blue-400 border border-blue-500/20">
                      {release.type}
                    </span>
                  </div>
